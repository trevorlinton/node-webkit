  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'src/api/control/control.cc',
        'src/api/control/control.h',
        'src/api/control/control_delegate_win.cc',
        'src/api/control/control_delegate_win.h',
        'src/api/control/control_delegate_mac.mm',
        'src/api/control/control_delegate_mac.h',
        'src/api/control/control_mac.mm',
        'src/api/control/control_win.cc',
